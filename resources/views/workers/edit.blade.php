        ...
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('workers.index') }}" class="btn btn-dark d-flex align-items-center" style="margin-left: 30px;">
                    ...
                    <h2 class="page-title mb-0">Edit Data Tukang</h2>
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="worker_id" name="worker_id" class="form-control" value="{{ old('worker_id', $worker->worker_id) }}" readonly>
                                @error('worker_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
