...
<div class="container-xl" style="padding-top:80px">
    ...
    <div class="row align-items-center" style="padding-bottom:20px">
        <div class="col d-flex align-items-center">
            <a href="{{ route('workers.index') }}" class="btn btn-dark d-flex align-items-center">
                <i class="ti ti-arrow-left"></i>
            </a>
                <h2 class="page-title">Detail Tukang</h2>
        </div>
    </div>
    ...
    <ul class="nav nav-tabs mb-3" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link" data-bs-toggle="tab" href="#tab-hr" role="tab">
                <i class="ti ti-id-badge"></i> Informasi Tukang
            </a>
        </li>
        <li class="nav-item" role="presentation">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="tab-personal" role="tabpanel">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('workers.edit', $worker->id) }}" class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" title="Ubah Detail">
        ...
        <div class="tab-pane fade" id="tab-hr" role="tabpanel">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h3 class="card-title mb-0">Informasi Tukang</h3>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="text-muted small">ID Tukang</div>
                            <div class="fw-bold">{{ $worker->worker_id }}</div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-muted small">Keterangan</div>
                            <div class="fw-bold">{{ $worker->notes ?? '-' }}</div>
                        </div>

                        <div class="col-md-4 mt-3">
                            <div class="text-muted small">Gaji/Penghasilan</div>
                            <div class="fw-bold">Rp {{ number_format($worker->salary, 0, ',', '.') }}</div>
                        </div>
                    </div>
                </div>
            </div>
