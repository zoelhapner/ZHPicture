    ...
    <div class="container-xl">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body p-5">
                ...
                <h2 class="fw-bold mb-4">Edit Paket: {{ $designPackage->name }}</h2>

                {{-- Update paket --}}
                <form action="{{ route('design-packages.update', $designPackage->id) }}"
                ...
                <form action="{{ route('design-packages.items.store', $designPackage->id) }}"
                      method="POST" class="mb-5">
                ...
                @include('design-packages.partials.items-table', [
                    'items' => $designPackage->items
                ])
