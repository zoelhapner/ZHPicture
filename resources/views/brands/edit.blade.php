            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('product_brands.update', $product_brand->id) }}" method="POST"  style="font-size: 1.5rem; font-weight: 400; font-family: 'Poppins', sans-serif;">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ old('name', $product_brand->name) }}" required>
                                    </div>
                                     <div class="col-md-6 mb-3">
                                        <label class="form-label">Asal Pabrik</label>
                                        <input type="text" name="factory_origin" class="form-control" value="{{ old('factory_origin', $product_brand->factory_origin) }}">
                                    </div>
