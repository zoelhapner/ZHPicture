    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('architects.index') }}" class="btn btn-dark d-flex align-items-center" style="margin-left: 30px;">
    ...
    <div class="container-xl">
        <div class="card shadow-sm border-0">
            <div class="card-body px-5 py-4">
                <form action="{{ route('architects.update', $architect->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    @if ($errors->any())
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="form-label required">Nomor Identitas architect </label>
                                <input type="text" id="architect_id" name="architect_id" class="form-control" value="{{ old('architect_id', $architect->architect_id) }}" readonly>
                                @error('architect_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="architect_name" class="form-control @error('architect_name') is-invalid @enderror" value="{{ old('architect_name', $architect->architect_name) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="architect_phone" class="form-control @error('architect_phone') is-invalid @enderror" value="{{ old('architect_phone', $architect->architect_phone) }}" required>
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="same_address" name="same_address"
                            @if(
                                $architect->province_id == $user->province_id &&
                                $architect->city_id == $user->city_id &&
                                $architect->district_id == $user->district_id &&
                                $architect->sub_district_id == $user->sub_district_id &&
                                $architect->postal_code_id == $user->postal_code_id
                            ) checked @endif>
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="architect_address" rows="2" class="form-control @error('architect_address') is-invalid @enderror">{{ old('architect_address', $architect->architect_address) }}</textarea>
