...
<div class="container-xl" style="padding-top:80px">
    ...
    <div class="row align-items-center" style="padding-bottom:20px">
        <div class="col d-flex align-items-center">
            <a href="{{ route('architects.index') }}" class="btn btn-dark d-flex align-items-center">
        ...
        <div class="tab-pane fade show active" id="tab-personal" role="tabpanel">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('architects.edit', $architect->id) }}" class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" title="Ubah Detail">
                        ...
                        <div class="col-md-6">
                            <div class="row g-3">
                                ...
                                {{-- <div class="col-md-6">
                                    ...
                                    <div class="fw-bold">{{ $architect->readable_category ?? '-' }}</div>
                                </div> --}}
                                <div class="col-md">
                                ...
                                {{-- <div class="col-md-4">
                                    ...
                                    <span class="badge {{ $architect->is_active ? 'bg-success' : 'bg-danger' }}">
                                        {{ $architect->status_text }}
                                    </span>
                                </div> --}}
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <div class="fw-bold">{{ $architect->architect_name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Nomor HP Usaha</div>
                            <div class="fw-bold">{{ $architect->architect_phone ?? '-' }}</div>
                        </div>
                        <div class="col-12">
                            <div class="text-muted small">Alamat Lengkap Usaha</div>
                            <div class="fw-bold">{{ $architect->architect_address ?? '-' }}</div>
                        </div>

                        <div class="col-md-3">
                            <div class="text-muted small">Kelurahan</div>
                            <div class="fw-bold">{{ $architect->subDistrict->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Kecamatan</div>
                            <div class="fw-bold">{{ $architect->district->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Kabupaten/Kota</div>
                            <div class="fw-bold">{{ $architect->city->name ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Provinsi</div>
                            <div class="fw-bold">{{ $architect->province->name ?? '-' }}</div>
                        </div>

                        <div class="col-md-3">
                            <div class="text-muted small">Kode Pos</div>
                            <div class="fw-bold">{{ $architect->postalCode->postal_code ?? '-' }}</div>
                        </div>
                        <div class="col-md-3">
                            <div class="text-muted small">Catatan</div>
                            <div class="fw-bold">{{ $architect->notes ?? '-' }}</div>
                        </div>
                    </div>
                </div>
            </div>
