        ...
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('investors.index') }}" class="btn btn-dark d-flex align-items-center" style="margin-left: 30px;">
                    ...
                    <h2 class="page-title mb-0">Tambah investor</h2>
                    ...
                    <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="investor_id" name="investor_id" class="form-control" required readonly>
                                @error('investor_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            {{-- <div class="col-md-4">
                                <label class="form-label required">Kategori investor</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="loyalty_level" class="form-select" value="{{ old('loyalty_level') }}" required>
                                    <option value="">-- Pilih Status --</option>
                                    <option value="1" {{ old('loyalty_level') == '1' ? 'selected' : '' }}>Silver</option>
                                    <option value="2" {{ old('loyalty_level') == '2' ? 'selected' : '' }}>Gold</option>
                                    <option value="3" {{ old('loyalty_level') == '3' ? 'selected' : '' }}>Platinum</option>
                                </select>
                            </div> --}}
                        ...
                        {{-- <div class="section-block mb-5">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="shipping_phone" class="form-control @error('shipping_phone') is-invalid @enderror" value="{{ old('shipping_phone') }}" required>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const investor_idField = document.getElementById('investor_id'); // ubah nama biar sesuai

        // Pastikan elemen ada dulu
        if (!investor_idField) return;

        fetch('{{ route('investors.generateInvestorId') }}', {
            headers: {
        ...
        .then(data => {
            if (data.investor_id) {
                investor_idField.value = data.investor_id; // variabel sekarang valid
            }
        })
        .catch(error => console.error('❌ Error fetching investor_id:', error));
    });
</script>
