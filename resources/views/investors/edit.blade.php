    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <a href="{{ route('investors.index') }}" class="btn btn-dark d-flex align-items-center" style="margin-left: 30px;">
                    <i class="ti ti-arrow-left"></i>
                </a>
                
                    <h2 class="page-title mb-0">Edit Data Investor</h2>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body px-5 py-4">
                <form action="{{ route('investors.update', $investor->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="section-block mb-5">
                        <h3 class="fw-semibold mb-3 border-bottom pb-2">Data Investor</h3>
                        <div class="row g-4">
                            <div class="col-md-4">
                                <label class="form-label required">ID Investor</label>
                                <input type="text" id="investor_id" name="investor_id" class="form-control" value="{{ old('investor_id', $investor->investor_id) }}" readonly>
                                @error('investor_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            {{-- <div class="col-md-4">
                                ...
                                <select name="category" class="form-select">
                                    <option value="">-- Pilih --</option>
                                    <option value="1" {{ old('category', $investor->category) == 1 ? 'selected' : '' }}>Individu</option>
                                    <option value="2" {{ old('category', $investor->category) == 2 ? 'selected' : '' }}>Perusahaan</option>
                                    <option value="3" {{ old('category', $investor->category) == 3 ? 'selected' : '' }}>Instansi</option>
                                    <option value="4" {{ old('category', $investor->category) == 4 ? 'selected' : '' }}>Lainnya</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Loyalty Level</label>
                                <select name="loyalty_level" class="form-select">
                                    <option value="1" {{ old('loyalty_level', $investor->loyalty_level) == 1 ? 'selected' : '' }}>Silver</option>
                                    <option value="2" {{ old('loyalty_level', $investor->loyalty_level) == 2 ? 'selected' : '' }}>Gold</option>
                                    <option value="3" {{ old('loyalty_level', $investor->loyalty_level) == 3 ? 'selected' : '' }}>Platinum</option>
                                </select>
                            </div> --}}
                    ...
                    {{-- <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" id="same_address" name="same_address"
                            @if(
                                $investor->province_id == $user->province_id &&
                                $investor->city_id == $user->city_id &&
                                $investor->district_id == $user->district_id &&
                                $investor->sub_district_id == $user->sub_district_id &&
                                $investor->postal_code_id == $user->postal_code_id
                            ) checked @endif>
                    ...
                    {{-- <div class="section-block mb-5">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="shipping_name" class="form-control @error('shipping_name') is-invalid @enderror" value="{{ old('shipping_name', $investor->shipping_name) }}" required>
                                @error('shiping_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" name="shipping_phone" class="form-control @error('shipping_phone') is-invalid @enderror" value="{{ old('shipping_phone', $investor->shipping_phone) }}" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="shipping_address" rows="2" class="form-control @error('shipping_address') is-invalid @enderror">{{ old('shipping_address', $investor->shipping_address) }}</textarea>
